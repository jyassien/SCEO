...
class FlagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flag" do
    assert_difference("Flag.count") do
      post flags_url, params: { flag: { description: @flag.description, flagged_at: @flag.flagged_at, flagged_by: @flag.flagged_by, reason: @flag.reason } }
    end
  ...
  test "should update flag" do
    patch flag_url(@flag), params: { flag: { description: @flag.description, flagged_at: @flag.flagged_at, flagged_by: @flag.flagged_by, reason: @flag.reason } }
