...
ActiveRecord::Schema[7.1].define(version: 2024_12_05_163306) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "created_events_count", default: 0, null: false
    t.integer "registered_events_count", default: 0, null: false
